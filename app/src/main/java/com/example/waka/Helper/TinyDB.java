...
public class TinyDB {
    ...
    public ArrayList<BebidasDomain> getListObject(String key){
        Gson gson = new Gson();

        ArrayList<String> objStrings = getListString(key);
        ArrayList<BebidasDomain> playerList =  new ArrayList<BebidasDomain>();

        for(String jObjString : objStrings){
            BebidasDomain player  = gson.fromJson(jObjString,  BebidasDomain.class);
    ...
    public void putListObject(String key, ArrayList<BebidasDomain> playerList){
        checkForNullKey(key);
        Gson gson = new Gson();
        ArrayList<String> objStrings = new ArrayList<String>();
        for(BebidasDomain player: playerList){
